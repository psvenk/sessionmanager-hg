...
/* ........ Menu Event Handlers .............. */
	...
	save: function(aWindow, aName, aFileName, aGroup, aOneWindow)
	{
		...
		let values = { text: this.getFormattedName(aWindow.content.document.title || "about:blank", new Date()) || (new Date()).toLocaleString(), autoSaveable : true };
		if (!aName)
		{
...
//			"chrome://sessionmanager/content/sessionexplorer.xul",
	...
	error: function(aException, aString) {
		...
		PROMPT_SERVICE.alert(this.getMostRecentWindow(), SM_BUNDLE.GetStringFromName("sessionManager"), SM_BUNDLE.formatStringFromName(aString, [(aException)?(aException.message + "\n\n" + aException.location):SM_BUNDLE.GetStringFromName("unknown_error")], 1));
	},
...
/* ........ Encryption functions .............. */
	...
	cryptError: function(aException, notSaved)
	{
		...
		PROMPT_SERVICE.alert(this.getMostRecentWindow(), this.mTitle, text);
	},
